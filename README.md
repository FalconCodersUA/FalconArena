...
- DB-backed background jobs для `deadline reminder`, `registration started`, `round started`, `submission closed` і email delivery з retry/idempotency

### Додаткові можливості

- Розклад турніру
- Профіль користувача з налаштуваннями
- Аватар користувача з файловим upload-збереженням
- Мовні уподобання
- Часовий пояс
...
- Фоновий worker для ключових tournament/round notification events і email delivery без дублювання повідомлень
