...
- публічна сторінка `Про нас` з продуктовим описом, банером, рольовими блоками, CTA і контактними каналами
- admin-only сторінка `Інтеграції / Налаштування системи`
- керування контентом сторінки `Про нас` з `Інтеграцій`: тексти, банер і контакти без зміни коду
