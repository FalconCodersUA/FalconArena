...
def main() -> int:
    ...
    values = {
        ...
        "GOOGLE_CLIENT_ID": os.getenv("GOOGLE_CLIENT_ID_VALUE", ""),
        "GOOGLE_CLIENT_SECRET": os.getenv("GOOGLE_CLIENT_SECRET_VALUE", ""),
        "GOOGLE_CALLBACK_URL": os.getenv("GOOGLE_CALLBACK_URL_VALUE", ""),
        "GITHUB_CLIENT_ID": os.getenv("GITHUB_CLIENT_ID_VALUE", ""),
        "GITHUB_CLIENT_SECRET": os.getenv("GITHUB_CLIENT_SECRET_VALUE", ""),
        "GITHUB_CALLBACK_URL": os.getenv("GITHUB_CALLBACK_URL_VALUE", ""),
        "FRONTEND_OAUTH_SUCCESS_URL": os.getenv("FRONTEND_OAUTH_SUCCESS_URL_VALUE", ""),
        "FRONTEND_OAUTH_FAILURE_URL": os.getenv("FRONTEND_OAUTH_FAILURE_URL_VALUE", ""),
    }
